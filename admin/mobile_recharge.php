        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><b>Mobile Recharge</b></h3>
                </div>
                <div class="box-body">
                    <!-- form start -->
                        ...
                        if ($fetchRecord = $mysqli->query($sql)) {
                            if ($fetchRecord->num_rows > 0) {
                                ...
                                while ($row = $fetchRecord->fetch_array()) {
                                    ...
                                    echo "<td>$row[3]</td>";
                                    echo "<td>$row[4]</td>";
                                    echo '<td><a href="delete_users.php?id='.$row[0].'&case=mobile" style="color: #ffffff;" class="btn btn-default btn-danger"><span class="glyphicon glyphicon-trash"></span>&nbsp;DELETE</a></td></tr>';
                                }
