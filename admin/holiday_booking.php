        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><b>Holiday Booking</b></h3>
                </div>
                <div class="box-body">
                    <!-- form start -->
                    <table id="example1" class="table table-bordered table-responsive table-hover">
                        ...
                        <tbody>
                        <?php
                        $sql = "SELECT * FROM holiday_booking";
                            ...
                            if ($fetchRecord->num_rows > 0) {
                                ...
                                while ($row = $fetchRecord->fetch_array()) {
                                    ...
                                    echo "<td>$row[4]</td>";
                                   	echo "<td>$row[5]</td>";
                                    echo "<td>$row[6]</td>";
                                    echo '<td><a href="delete_users.php?id='.$row[0].'&case=holiday" style="color: #ffffff;" class="btn btn-default btn-danger"><span class="glyphicon glyphicon-trash"></span>&nbsp;DELETE</a></td></tr>';
                                }
