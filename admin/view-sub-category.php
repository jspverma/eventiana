                ...
                <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-responsive table-hover">
                        ...
                        <tr>
                            ...
                            <th>Whats Excluded</th>
                            <th>Need to Know</th>
                            <th>Address</th>
                            <th>Schedule date time</th>
                            <th>Available Customizations</th>
                            <th>Reviews</th>
                            <th>Total Cost</th>
                        ...
                        if ($fetchRecord = $mysqli->query($sql)) {
                            if ($fetchRecord->num_rows > 0) {
                                ...
                                while ($row = $fetchRecord->fetch_array()) {
                                   ...
                                   echo "<td>$row[12]</td>";
								    echo "<td><img src='$row[13]' style='widht: 100px !important;height: 83px;border: 1px solid #dd4b39;padding: 2px;'></td>";
								   echo "<td>$row[14]</td>";  
                                    echo '<td><a href="delete_users.php?id='.$row[0].'&case=sub-catigory" style="color: #ffffff;" class="btn btn-default btn-danger"><span class="glyphicon glyphicon-trash"></span>&nbsp;DELETE</a></td></tr>';
                                }
