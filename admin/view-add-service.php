            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-responsive table-hover">
                        ...
                        <tbody>
                        <?php
                        $sql = "SELECT * FROM add_options_tbl";
                        if ($fetchRecord = $mysqli->query($sql)) {
                            if ($fetchRecord->num_rows > 0) {
                                ...
                                while ($row = $fetchRecord->fetch_array()) {
								   ...
								   echo "<td>$row[4]</td>";
								   echo "<td>$row[5]</td>";
								    echo "<td><img src='$row[6]' style='widht: 100px !important;height: 83px;border: 1px solid #dd4b39;padding: 2px;'></td>";
									echo "<td>$row[7]</td>";
								    
                                    echo '<td><a href="delete_users.php?id='.$row[0].'&case=service" style="color: #ffffff;" class="btn btn-default btn-danger"><span class="glyphicon glyphicon-trash"></span>&nbsp;DELETE</a></td></tr>';
                                }
