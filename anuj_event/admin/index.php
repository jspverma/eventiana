                        ...
                        if ($fetchRecord = $mysqli->query($sql)) {
                            if ($fetchRecord->num_rows > 0) {
                                ...
                                while ($row = $fetchRecord->fetch_array()) {
                                    ...
                                    echo '<td><a href="delete_users.php?id='.$row[0].'&case=user" style="color: #ffffff;" class="btn btn-default btn-danger"><span class="glyphicon glyphicon-trash"></span>&nbsp;DELETE</a></td></tr>';
                                }
