        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><b>view Slider</b></h3>
                </div>
                <div class="box-body">
                    <!-- form start -->
                        ...
                        if ($fetchRecord = $mysqli->query($sql)) {
                            if ($fetchRecord->num_rows > 0) {
                                ...
                                while ($row = $fetchRecord->fetch_array()) {
                                    ...
                                    echo "</td>";
                                    echo "<td>$row[2]</td>";
									echo "<td><img src='$row[3]' style='widht: 100px !important;height: 83px;border: 1px solid #dd4b39;padding: 2px;'></td>";
                                    
                                    echo '<td><a href="delete_users.php?id='.$row[0].'&case=slider" style="color: #ffffff;" class="btn btn-default btn-danger"><span class="glyphicon glyphicon-trash"></span>&nbsp;DELETE</a></td></tr>';
                                }
