...
$tmpname=$_FILES['image']['tmp_name'];
	...
	move_uploaded_file($tmpname,"slider_image/".$filename);
	$path="slider_image/".$filename;
...
if(isset($_POST['submit']))
{
	...
	$pera= mysqli_real_escape_string($mysqli, $_POST['pera']);
	
	

    $sql = "INSERT INTO `slider_tbl` (`id`, `title`, `peragraph`, `slider_imag`) VALUES (NULL, '$title', '$pera', '$path');";
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="col-md-4">
                    ...
                    <div class="name">
                    <input type="text" name="pera" placeholder="Paragraph" >
                    </div>
