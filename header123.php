...
<!-- Mirrored from unicaevents.ancorathemes.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Aug 2017 11:53:08 GMT -->
...
<body class="home page-template-default page page-id-133 unicaevents_body body_style_wide body_filled theme_skin_default article_style_stretch layout_single-standard template_single-standard top_panel_show top_panel_above sidebar_hide sidebar_outer_hide wpb-js-composer js-comp-ver-5.1 vc_responsive">
		...
		<header class="top_panel_wrap top_panel_style_3 scheme_original">
			<div class="top_panel_wrap_inner top_panel_inner_style_3 top_panel_position_above">
				...
				if($_SESSION['email_id']){
					             ...
					             echo"  <div class='login-bar1'>
								 <div class='top_panel_top_login'>
					<b>Welcome : </b> <a href='Login, Sign up page/logout.php' style='color: #fcb41e;'>" .$_SESSION['name']." </a>
					</div>
				</div>";    
               ...
               <?php
                ...
                <div class="login-bar1">
					<div class="top_panel_top_login"><a href="Login, Sign up page/login-sign.php" style="color: #fcb41e;">Login </a></div>
				</div>
	...
	<div class="top_panel_top_contact_email"><a class="__cf_email__" href="cdn-cgi/l/email-protection.html" data-cfemail="e28b8c848da2838c818d9083968a878f8791cc818d8f">[email&#160;protected]</a><script data-cfhash='f9e31' type="text/javascript">/* <![CDATA[ */!function(t,e,r,n,c,a,p){try{t=document.currentScript||function(){for(t=document.getElementsByTagName('script'),e=t.length;e--;)if(t[e].getAttribute('data-cfhash'))return t[e]}();if(t&&(c=t.previousSibling)){p=t.parentNode;if(a=c.getAttribute('data-cfemail')){for(e='',r='0x'+a.substr(0,2)|0,n=2;a.length-n;n+=2)e+='%'+('0'+('0x'+a.substr(n,2)^r).toString(16)).slice(-2);p.replaceChild(document.createTextNode(decodeURIComponent(e)),c)}p.removeChild(t)}}catch(u){}}()/* ]]> */</script></div>
				...
				<div class="content_wrap">
					<div class="columns_wrap columns_fluid"><div
						class="column-1_3 contact_logo">
									<div class="logo">
			<a href="index.php"><img src="wp-content/uploads/2015/11/nica_dark.png" class="logo_main" alt="" width="182" height="48"><img src="wp-content/uploads/2015/11/nica_dark.png" class="logo_fixed" alt="" width="182" height="48"><div class="logo_slogan">Event Agency</div></a>
		</div>
								</div><div 
						class="column-2_3 menu_main_wrap">
							<a href="#" class="menu_main_responsive_button icon-menu"></a>
							<nav class="menu_main_nav_area">
								<ul id="menu_main" class="menu_main_nav"><li id="menu-item-792" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-792"><a href="index.php">Home</a>
<ul class="sub-menu">
...
<li id="menu-item-124" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-124"><a href="event.php">Features</a>
<!--<ul class="sub-menu">
